...
<div class="container custom-container-register">
    <div class="row justify-content-center">
        <div class="col-md-8">
                ...
                <div class="card-header-register">{{ __('CADASTRE-SE') }}</div>
                ...
                <div class="card-body custom-card-body-register">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="telefone" type="text" class="form-control @error('telefone') is-invalid @enderror" name="telefone" value="{{ old('telefone') }}" required autocomplete="email">
